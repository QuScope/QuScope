...
def compare_projected_potentials(V_quantum: np.ndarray, V_classical: np.ndarray, sampling: float = 0.1, save_path=None):
    ...
    im2 = axes[2].imshow(np.abs(V_quantum - V_classical), origin='lower', extent=extent, cmap='inferno')

...
def validate_with_abtem_potential():
    ...
    print(f"  ✓ Classical intensity: [{I_classical.min():.6f}, {I_classical.max():.6f}]")
    ...
    plt.suptitle(f'Validation with abTEM Potential @ {voltage/1e3:.0f} kV\n' + 

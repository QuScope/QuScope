...
class TestStatePreparationOptimizer:
    ...
    def test_normalization_flag(self):
        ...
        circuit_no_norm = optimizer.prepare_state(psi_normalized, n_qubits, normalize=False)
...
class TestIntegration:
    ...
    def test_full_optimization_pipeline(self):
        ...
        print(f"  Before transpilation: depth={metrics_before['depth']}, "
              f"gates={metrics_before['gates']}")
        print(f"  After transpilation:  depth={metrics_after['depth']}, "
    ...
    def test_schmidt_vs_direct_comparison(self):
        ...
        print(f"  Direct:  depth={metrics_direct['depth']}, "
              f"gates={metrics_direct['gates']}")
        print(f"  Schmidt: depth={metrics_schmidt['depth']}, "

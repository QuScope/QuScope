...
class TestUncertaintyPrinciple:
    ...
    def test_narrow_real_space_wide_momentum(self):
        ...
        result_narrow = demonstrate_uncertainty_principle(
            n_qubits=3, width_real=0.5
        )
        
        # Wide in real space
        result_wide = demonstrate_uncertainty_principle(
            n_qubits=3, width_real=3.0
        )
...
class TestIntegration:
    ...
    def test_complete_momentum_pipeline(self):
        ...
        print(f"  Momentum spread: Δkx={analysis['k_spread'][0]:.3f}, "
